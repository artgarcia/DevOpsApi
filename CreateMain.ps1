...
#
Copy-ProcessAndWorkItemType -userParams $userParameters -InheritedProcessName "artgarciavsts Agile" -DestinationProcess "New2 Agile Process" -WorkItemCopyFrom "Feature" -WorkItemToCopy "New Feature"
